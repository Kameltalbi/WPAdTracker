...
# Ad Banner Scanner v1.0.0

echo "🚀 Création du package Ad Banner Scanner pour WordPress.org..."
echo ""
...
rm -f SECURITY-AUDIT.md SUBMISSION-GUIDE.md SOUMISSION-ETAPES.md
rm -f WORDPRESS-ORG-COMPLIANCE.md WORDPRESS-ORG-READY.md
rm -f FREEMIUM-STRATEGY.md FREEMIUM-STRATEGY-REVISED.md
rm -f READY-FOR-WORDPRESS-ORG.md NOMS-ALTERNATIFS.md
rm -f create-package.sh create-package-new.sh
...
echo ""
echo -e "${BLUE}📖 Lire SOUMISSION-ETAPES.md pour les instructions détaillées${NC}"
echo ""
